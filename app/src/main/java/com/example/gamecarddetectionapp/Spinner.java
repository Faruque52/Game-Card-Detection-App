...
public class Spinner extends AppCompatActivity {
    ...
    private android.widget.Spinner stateSpinner, districtSpinner;                  //Spinners
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(v -> {
            if (selectedState.equals("Select Your State")) {
                Toast.makeText(Spinner.this, "Please select your state from the list", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(Spinner.this, "Please select your district from the list", Toast.LENGTH_LONG).show();
